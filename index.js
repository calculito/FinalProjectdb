...
app.put("/homeworkfinished/:homeworkId", function (req, res) {
  let homeworkId = req.params.homeworkId;
  const newEmail = req.body.email;
  pool
    .query("UPDATE homework_finished SET finished = 'yes' WHERE id=$1", [
      homeworkId,
    ])
...
app.put("/homeworkfinishedlink/:homeworkId", function (req, res) {
  ...
  pool
    .query("UPDATE homework_finished SET linkhwfinished = $2 WHERE id=$1", [
      homeworkId,
      linkToHomework,
    ])
